...
The MHGL trainer calls ``fit_pde`` on labelled-normal node indices. Labelled
anomalies enter Eq. 3.6 directly through the repulsion term rather than through
abnormal-pattern centres.
"""
